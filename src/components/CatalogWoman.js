...
export function CatalogWoman() {

    return (
        <>
            <div className={styles['collection-header']}>
                <div className={styles['collection-hero']}>
                    <div className={styles['collection-hero-img-container']}><img className={styles['collection-hero-image']} src="https://res.cloudinary.com/diby8tbnn/image/upload/v1677854615/banner-home-alexinternational-WOMENS-CLOTHING_gmxjbn.jpg" /></div>
                </div>
            </div>
            ...
            <div className={styles['grid-container']}>
                ...
                <div className={styles['catalog-grid']}>
                    <div className={styles['catalog-current']}>
                        <a href="#">
                            <img className={styles['product-image']} src="https://res.cloudinary.com/diby8tbnn/image/upload/v1677854614/collection2_vajifd.jpg" />
                        </a>
                        <div>
