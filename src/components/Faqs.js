        ...
        <>
            ...
            <div className={styles['faq-container']}>
                ...
                <div className={styles['faq-body']}>
                    <h4 id="collapseOne" className={styles['panel-title']} aria-expanded="false" onClick={showFaq}>What is Lorem Ipsum?</h4>
                ...
                <div className={styles['faq-body']}>
                    <h4 id="collapseTwo" className={styles['panel-title']} aria-expanded="false" onClick={showFaq}>Why do we use it?</h4>
                ...
                <div className={styles['faq-body']}>
                    <h4 id="collapseThree" className={styles['panel-title']} aria-expanded="false" onClick={showFaq}>How to use this template?</h4>
                ...
                <div className={styles['faq-body']}>
                    <h4 id="collapseFour"  className={styles['panel-title']} aria-expanded="false" onClick={showFaq}>What is Lorem Ipsum?</h4>
                ...
                <div className={styles['faq-body']}>
                    <h4 id="collapseFive" className={styles['panel-title']} aria-expanded="false" onClick={showFaq}>Why do we use it?</h4>
                ...
                <div className={styles['faq-body']}>
                    <h4 id="collapseSix" className={styles['panel-title']} aria-expanded="false" onClick={showFaq}>How to use this template?</h4>
